    ...
    <>
      <NavBar>
        <Search query={query} setQuery={setQuery}>
          <NumberResults animes={filteredAnimes} />
        </Search>
      </NavBar>
      <Main>
        <Box>
          <AnimeList animes={filteredAnimes} handleSelectedAnime={handleSelectedAnime} />
        </Box>
        <Box>
...
function AnimeList({ animes, handleSelectedAnime }) {
  return (
    <ul className="list list-anime">
      {animes?.map((anime) => (
        <Anime key={anime.mal_id} anime={anime} handleSelectedAnime={handleSelectedAnime} />
      ))}
    </ul>
  );
}

function Anime({ anime, handleSelectedAnime }) {
  return (
